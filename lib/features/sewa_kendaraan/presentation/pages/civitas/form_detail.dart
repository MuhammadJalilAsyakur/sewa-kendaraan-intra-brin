              ...
              child: Column(
                children: [
                  CustomTextField(
                    ...
                    onChanged: (val) {
                      provider.updateDataPenanggungJawab(
                        penananggungJawab.copyWith(namaPenanggungJawab: val),
                      );
                    },
                  ),
                  ...
                  CustomTextField(
                    ...
                    onChanged: (val) {
                      provider.updateDataPenanggungJawab(
                        penananggungJawab.copyWith(nomorHpPenanggungJawab: val),
                      );
                    },
                  ),
                  const SizedBox(height: 16),
                  CustomTextField(
                    ...
                    onChanged: (val) {
                      provider.updateDataPenanggungJawab(
                        penananggungJawab.copyWith(email: val),
                      );
                    },
                  ),
                ],
              ...
              child: Column(
                children: [
                  CustomTextField(
                    ...
                    onChanged: (val) {
                      provider.updateKegiatanDanTujuan(
                        kegiatan.copyWith(namaKegiatan: val),
                      );
                    },
                  ),
                  const SizedBox(height: 16),
                  CustomTextField(
                    ...
                    onChanged: (val) {
                      provider.updateKegiatanDanTujuan(
                        kegiatan.copyWith(keperluan: val),
                      );
                    },
                  ),
                  const SizedBox(height: 16),
                  CustomTextField(
                    ...
                    onChanged: (val) {
                      provider.updateKegiatanDanTujuan(
                        kegiatan.copyWith(tujuanPerjalanan: val),
                      );
                    },
                  ),
                ],
              ...
              child: Column(
                children: [
                  CustomTextField(
                    ...
                    onChanged: (val) {
                      provider.updateInfoPenumpang(
                        penumpang.copyWith(jumlahPenumpang: int.tryParse(val)),
                      );
                    },
                  ),
                  const SizedBox(height: 16),
                  CustomDropdown<String>(
                    ...
                    value: penumpang.statusPengemudi,
                    validator: (value) {
                    ...
                    onChanged: (val) {
                      provider.updateInfoPenumpang(
                        penumpang.copyWith(statusPengemudi: val),
                      );
                    },
                  ),
                ],

...
class _FormIndentitas extends State<FormIndentitas> {
  ...
  void initState() {
    ...
    nomorSuratController = TextEditingController(
      text: _controller.administrasiInfo.nomorSuratPengantar ?? '',
    );
    keteranganPemohonController = TextEditingController(
      text: _controller.administrasiInfo.keteranganPemohon ?? '',
    );
    _worker = ever(_controller.administrasiInfoRx, (_) => _syncControllers());
  }

  void _syncControllers() {
    if (nomorSuratController.text !=
        (_controller.administrasiInfo.nomorSuratPengantar ?? "")) {
      nomorSuratController.text =
          _controller.administrasiInfo.nomorSuratPengantar ?? '';
    }
    if (keteranganPemohonController.text !=
        (_controller.administrasiInfo.keteranganPemohon ?? '')) {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      final dataPemohon = _controller.dataPemohon;
      final adminInfo = _controller.administrasiInfo;
                  ...
                  child: Column(
                    children: [
                      CustomDropdown<String>(
                        ...
                        onChanged: (val) {
                          _controller.updateAdminsitrasiInfo(
